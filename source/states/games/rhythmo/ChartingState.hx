...
class ChartingState extends BeatState
{
	...
	function addSongUI():Void
	{
		...
		var characters:Array<String> = ["player", 'opponent'];
	...
	function addSectionUI():Void
	{
		...
		var copyButton:FlxButton = new FlxButton(110, 8, "Copy last section", () ->
		{
	...
	function loadSong(daSong:String):Void
	{
		...
		FlxG.sound.playMusic(Paths.music('rhythmo/' + daSong + "_Inst"), 0.6);

		vocals = new FlxSound().loadEmbedded(Paths.music("rhythmo/" + daSong + "_Voices"));
	...
	function calculateSectionLengths(?sec:SectionArray):Int
	{
		var daLength:Int = 0;
