...
class MenuState extends FlxState
{
    ...
    override public function create()
    {
        ...
        var btnProfile:ClickableSprite = new ClickableSprite(0, 0, 'menu/profile/' + SaveData.settings.get('profile'), () -> 
        {
    ...
    override public function update(elapsed:Float)
    {
        ...
        dateText.text = DateTools.format(Date.now(), "%F") + ' / ' + DateTools.format(Date.now(), SaveData.settings.get('timeFormat'));
    }
